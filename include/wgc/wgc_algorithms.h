...
namespace wgc
{
  ...
  public:
    ...
    operator-(const IndexedEntityIterator<E, I>& LHS, const IndexedEntityIterator<E, I>& RHS);
  };

  template <typename EntityIter, typename IndexIter>
  inline typename IndexedEntityIterator<EntityIter, IndexIter>::difference_type
  operator-(const IndexedEntityIterator<EntityIter, IndexIter>& LHS,
  ...
  void ForEachIndexedEntity(IndexIter IndexStart,
                            IndexIter IndexLast,
                            EntityIter EntityFirst,
                            ...
                            F Callback)
  {
    Chunk(IndexStart,
          ...
          [&EntityFirst, &Callback](IndexIter First, IndexIter Last) {
            Callback(IndexedEntityIterator(First, EntityFirst),
